...
{
    public class Android_Service_Client
    {
        // events
        ...
        public static Android_Service_Client Current
        {
            get { return current; }
        }
        private static Android_Service_Client current;
        ...
        static Android_Service_Client()
        {
            current = new Android_Service_Client();
        }

        protected Android_Service_Client()
        {
